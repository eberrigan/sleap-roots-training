...
class TestFetchModelArtifactFromExperiment:
    ...
    def test_fetch_model_artifact_from_experiment_latest(self, mock_print, mock_wandb_init):
    ...
    @patch('sleap_roots_training.models.wandb.init')
    @patch('builtins.print')
    def test_fetch_model_artifact_from_experiment_specific_version(self, mock_print, mock_wandb_init):
    ...
    def test_fetch_model_artifact_print_messages(self, mock_print, mock_wandb_init):
        ...
        mock_print.assert_has_calls([pytest.mock.call(*args) for args in expected_calls])
...
class TestFetchModelArtifactAndLinkToRegistry:
    ...
    def test_fetch_and_link_to_registry(self, mock_print, mock_wandb_init):
        ...
        mock_run.link_artifact.assert_called_once_with(
            mock_artifact, "test_entity-org/wandb-registry-test_registry/test_collection"
        )
        mock_run.finish.assert_called_once()
    ...
    def test_fetch_and_link_specific_version(self, mock_print, mock_wandb_init):
        ...
        fetch_model_artifact_and_link_to_registry(
            "test_project", "test_entity", "test_artifact", 
            "test_registry", "test_collection", "v2"
        )
...
class TestPromoteModelInRegistry:
    ...
    def test_promote_model_in_registry(self, mock_print, mock_wandb_init):
        ...
        # Call function
        promote_model_in_registry(
            "test_project", "test_entity", "test_registry", 
            "test_artifact", "production"
        )
        
        # Assertions
        mock_wandb_init.assert_called_once_with(
            project="test_project", entity="test_entity", job_type="promote_registry_artifact"
        )
        mock_run.use_artifact.assert_called_once_with("test_registry/test_artifact:latest:latest")
    ...
    def test_promote_model_specific_version(self, mock_print, mock_wandb_init):
        ...
        promote_model_in_registry(
            "test_project", "test_entity", "test_registry", 
            "test_artifact", "staging", "v3"
        )
        
        # Assertions
        mock_run.use_artifact.assert_called_once_with("test_registry/test_artifact:v3:latest")
