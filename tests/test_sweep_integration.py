...
class TestSweepIntegrationWithMocks:
    ...
    def test_config_update_with_real_sweep_params(self, temp_experiment_dir):
        ...
        with patch("sleap_roots_training.train.wandb.config") as mock_wandb_config:
            ...
            with patch("builtins.dict", return_value={
                ...
                assert "sigma" in updated_config["model"]["heads"]["multi_instance"]["confmaps"]
    ...
    def test_run_sweep_training_with_real_data(
        ...
        assert created_sweep_config["name"] == f"{environment_config['experiment_name']}_v000_sweep"
        ...
        assert make_fn_call_args[1]["experiment_name"] == environment_config["experiment_name"]
...
class TestPureIntegration:
    ...
    def test_parameter_combinations_calculation(self, realistic_sweep_config, small_sweep_config):
        ...
        random_config = {"method": "random", "parameters": {"param1": {"values": [1, 2]}}}
    ...
    def test_file_path_generation_during_sweep(self, temp_experiment_dir):
        ...
        expected_path = data_dir / f"sweep_config_v{version.zfill(3)}_{timestamp}_{run_id}.json"
    ...
    def test_environment_fixture_values(self, environment_config):
        ...
        required_keys = ["project_name", "entity_name", "experiment_name", "registry_name", "tags", "model_tags"]
