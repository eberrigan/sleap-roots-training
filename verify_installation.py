...
def check_python_version():
    ...
    if major == 3 and 7 <= minor <= 9:
        ...
        print(
            "[ERROR] Python version not compatible (requires Python 3.7-3.9 for SLEAP)"
        )
        return False
...
def check_package_installation():
    ...
    try:
        ...
        print(
            f"[OK] sleap-roots-training imported successfully (version: {sleap_roots_training.__version__})"
        )
